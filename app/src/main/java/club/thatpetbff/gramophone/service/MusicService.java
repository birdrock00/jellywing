...
import club.thatpetbff.gramophone.glide.BlurTransformation;
...
import club.thatpetbff.gramophone.service.notifications.PlayingNotification;
import club.thatpetbff.gramophone.service.notifications.PlayingNotificationMarshmallow;
import club.thatpetbff.gramophone.service.notifications.PlayingNotificationNougat;
import club.thatpetbff.gramophone.service.playback.LocalPlayer;
import club.thatpetbff.gramophone.service.playback.Playback;
import club.thatpetbff.gramophone.service.playback.PlaybackListener;
import club.thatpetbff.gramophone.service.receivers.MediaButtonIntentReceiver;
import club.thatpetbff.gramophone.util.PreferenceUtil;
import club.thatpetbff.gramophone.util.Util;
import club.thatpetbff.gramophone.views.widgets.AppWidgetAlbum;
import club.thatpetbff.gramophone.views.widgets.AppWidgetCard;
import club.thatpetbff.gramophone.views.widgets.AppWidgetClassic;
...
public class MusicService extends Service implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void playSongAt(final int position) {
        if (position < 0 || position >= queueManager.getPlayingQueue().size()) {
            return;
        }
